        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-light active">Data Nasabah</li>
                </ol>
            </nav>
            <div>
                    ...
                    <div class="card"
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#tambahNasabahModal">
                                + Tambah
                            </button>

                            <!-- Modal Tambah Nasabah -->
                            <div class="modal fade custom-modal" id="tambahNasabahModal" tabindex="-1"
                                role="dialog" aria-labelledby="tambahNasabahModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4><b class="modal-title" id="tambahNasabahModalLabel">Tambah Nasabah</b>
                                            </h4>
                                        ...
                                        <div class="modal-body">
                                            <!-- Isi form atau konten tambah nasabah di sini -->
                                            <!-- Tambah Nasabah Form -->
                                            <form method="POST" action="{{ route('storeNasabah') }}">
                                                @csrf
                                                <!-- Nama -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <!-- <a href="{{ route('detailNasabah', ['id' => $nasabah->id]) }}" class="btn btn-primary">Detail</a> -->
                                                    <button type="button" class="btn btn-warning"
                                                        data-toggle="modal"
                                                        data-target="#detailNasabahModal-{{ $nasabah->id }}">
                                                        Detail
                                                    </button>
                                                    
                                                    <!-- Modal Detail Nasabah -->
                                                    <div class="modal fade custom-modal"
                                                        id="detailNasabahModal-{{ $nasabah->id }}" tabindex="-1"
                                                        role="dialog" aria-labelledby="detailNasabahModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="detailNasabahModalLabel">Detail
                                                                        {{ $nasabah->name }}</h5>
                                                ...
                                                <button type="button" class="btn btn-info" data-toggle="modal"
                                                    data-target="#editNasabahModal-{{ $nasabah->id }}"> Edit
                                                </button>
                                                <div class="modal fade custom-modal" id="editNasabahModal-{{ $nasabah->id }}"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="detailNasabahModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="editNasabahModalLabel">
                                                                    Edit {{ $nasabah->name }}</h5>
                                                                <button type="button" class="close"
                                                                    data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('updateNasabah', ['id' => $nasabah->id]) }}">
                                                                    @csrf
                                                                    <!-- Field lainnya sesuai dengan data nasabah -->
                                                                    <div class="form-group">
                                                                        <label for="nama">Nama</label>
                                                                        <input type="text" class="form-control"
                                                                            id="name" name="name"
                                                ...
                                                <div>
                                                    <a href="{{ route('deleteNasabah', ['id' => $nasabah->id]) }}"
