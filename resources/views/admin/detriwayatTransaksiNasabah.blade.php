        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-light active">History</li>
                </ol>
            </nav>
            <div>
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin">
                            <div class="col-lg-12 grid-margin">
                                <div
                                    class="card"style="border-radius: 15px;background-image: url('theme-assets/images/backgrounds/4860404.jpg'); background-size: cover;">
                                    <div class="card-body" >

                                        <h4 class="card-title">History Nasabah </h4>
                                        <div>
                                            <div>
                                                {!! $cetakButton !!}
                                            </div>
                                            ...
                                            <form method="GET"
                                                action="{{ route('detailRiwayatNasabah', ['user_id' => $userId]) }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select class="form-control" id="date" name="date">
                                                            ...
                                                            @for ($d = 1; $d <= 31; $d++)
                                                                <option value="{{ sprintf('%02d', $d) }}" {{ request('date') == sprintf('%02d', $d) ? 'selected' : '' }}>
                                                                    {{ sprintf('%02d', $d) }}
                                                                </option>
                                                            @endfor
                                                        </select>
                                                ...
                                                <button type="submit" class="btn btn-light">Filter</button><br><br>
                                              

                                                {{-- <div class="row mb-3">
                                                    <div class="col-md-3">
                                                        <input type="number" name="date" class="form-control" placeholder="Tanggal" value="{{ request('date') }}" min="1" max="31">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="number" name="month" class="form-control" placeholder="Bulan" value="{{ request('month') }}" min="1" max="12">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="number" name="year" class="form-control" placeholder="Tahun" value="{{ request('year') }}" min="2000" max="{{ date('Y') }}">
                                                    </div>
                                                    <div class="col-md-3">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    @php
                                                    $startNumber = ($Sampah->currentPage() - 1) * $Sampah->perPage() + 1;
                                                @endphp
                                                    @foreach ($Sampah as $sampah)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                style="
                                                            @if ($sampah->status == 'belum disetujui') color: red;
                                                            @elseif ($sampah->status == 'disetujui')
                                                                color: green; 
