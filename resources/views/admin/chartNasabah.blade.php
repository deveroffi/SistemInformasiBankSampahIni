                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-12">
                                                                <div
                                                                    style="border: 1px solid black; border-radius: 40px; overflow: hidden; background-image: url('theme-assets/images/backgrounds/card.png'); background-size: cover; padding: 10px;">
                                                                    <br>
                                                                    <h4 class="card-title">Transaksi Masuk</h4>
                                                                    <h6 class="card-subtitle text-muted">Jenis Sampah
                                                                    </h6>
                                                                    <canvas id="chartNasabah"
                                                                        style="margin-top: 120px;">></canvas>
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-6 col-lg-12">
                                                                <div
                                ...
                                <div class="row">
                                    <div class="col-md-12 grid-margin">
                                        <div class="col-lg-12 grid-margin">
                                            <div class="card" style="border-radius: 40px;">
                                                <div class="card-body">
                                                    <h4 class="card-title">Sebaran Transaksi</h4>
                                                    <h6 class="card-subtitle text-muted">Nasabah</h6>
                                                                                ...
                                                                                function initMap() {
                                                                                    ...
                                                                                    if (!mapInitialized) {
                                                                                        ...
                                                                                        @foreach ($Sampah as $key => $lokasi)
                                                                                            ...
                                                                                            var color = '#0000FF'; // Warna biru untuk semua titik
                                                                                            ...
                                                                                            var marker = new google.maps.Marker({
                                                                                                ...
                                                                                                icon: {
                                                                                                    ...
                                                                                                    fillColor: color, // Warna marker biru
