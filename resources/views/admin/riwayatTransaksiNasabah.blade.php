        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-light active">Riwayat Transaksi Nasabah</li>
                </ol>
            </nav>
            <div>
                ...
                <li class="dropdown dropdown-user nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="#"><i class="ft-check-square"></i> Task</a> -->
                            <a class="dropdown-item" href="{{route('editProfil')}}"><i class="ft-check-square"></i>Edit Profil</a>
                            <div class="dropdown-divider"></div>
                ...
                <div class="col-md-12 grid-margin">
                    <div class="card"
                        ...
                        <div class="card-body" style="border-radius: 15px">
                            <h4 class="card-title">Riwayat Transaksi Nasabah</h4>
                            <div id="recent-buyers" class="media-list">
                                @foreach ($Nasabah as $nasabah)
                                <a href="{{ route('detailRiwayatNasabah', ['user_id' => $nasabah->id]) }}"
                                    class="card-link">
                                        ...
                                        <div class="card" style="border-radius: 15px">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-1">
                                                        <!-- Tambahkan ikon pengguna di sini -->
                                                        <img src="theme-assets\images\icon\user.png"
                                                            style="width: 80px; height: 80px;">
                                                    </div>
                                                    <div class="col-11">
                                                        <!-- Tampilkan nama pengguna -->
                                                        <h5 class="card-title">{{ $nasabah->name }}</h5>
                                                        <!-- Tampilkan email pengguna -->
                                                        <i>
                                                            <p class="card-text">{{ $nasabah->email }}</p>
                                                        </i>
                                                    </div>
                                                </div>
                                            </div>
