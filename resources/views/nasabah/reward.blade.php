            ...
            <li class="dropdown dropdown-user nav-item">
                ...
                <div class="dropdown-menu" style="width: 450px">
                    <div>
                        ...
                        @foreach ($transaksiss as $transaksi)
        ...
        <div class="card-body"
            ...
            <div>
                <div style="margin-top: 20px;">
                    ...
                    <b class="card-title">Saldo Anda = Rp. {{ number_format($totalReward, 0, ',', '.') }}</b><br>
                    <i class="card-title" style="font-size: 12px;">*Saldo dihitung dari transaksi yang berstatus
                    </i>
                    <i class="card-title" style="font-size: 12px;color: blue;">selesai</i>
                    <br><br>
                </div>
                    ...
                    <tbody>
                        @foreach ($Sampah as $sampah)
                            <tr>
                                ...
                                <td
                                    style="color: {{ $sampah->lokasiPenjemputan->status == 'selesai' ? 'blue' : 'black' }}; font-style: {{ $sampah->lokasiPenjemputan->status == 'selesai' ? 'italic' : 'italic' }}">
                                ...
                                <td> Rp. {{ number_format($sampah->harga_sampah, 0, ',', '.') }}</td>
                        @endforeach
                    </tbody>
                </table>
