...
<head>
    ...
    */
    ...
    --------------------------------------------------------------*/
    .cta {
    background: linear-gradient(rgba(66, 84, 81, 0.5), rgba(43, 56, 54, 0.5)), url("../img/cta-bg.jpg") fixed center
    center;
    background-size: cover;
    padding: 60px 0;
    }
...
<body>
  ...
  <footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
          &copy; Universitas Islam Negeri Sunan Ampel <strong><span>Surabaya</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          copyright <a href="https://bootstrapmade.com/">2024</a>
        </div>
      </div>
    </footer><!-- End Footer -->
  </footer><!-- End Footer -->
